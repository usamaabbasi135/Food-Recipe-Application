...
import com.example.foodrecipe.usamaabbasi1835.Adapters.RandomRecipeAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                tags.clear();
                tags.add(query);
                manager.getRandomRecipes(responseListenerRandomRecipe, tags);
                dialog.show();
                return true;
            }
        ...
        manager = new RequestManagerAPI(this);
//        manager.getRandomRecipes(responseListenerRandomRecipe, );
//        dialog.show();
    }

    private final ResponseListenerRandomRecipe responseListenerRandomRecipe
            = new ResponseListenerRandomRecipe() {
        @Override
